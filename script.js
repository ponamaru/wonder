window.addEventListener('load',function(){
    ...
    text[0] = [
        ...
        "シェナに傘を届けに行こう",
        "<changeimg>シェナが行くって言ってたのはビーストアだ",
        "ここか",
        "<changeimg2><audio>",
        "「二度と来んな！」",
     ];
    ...
    text[1] = [
        "・新聞<break>10月23日～10月30日朝刊までのニュースを見ることができる。",
        "ざっと目を通して手に入った情報は",
        "・蛇に関係する事件が多い蛇にかまれて病院送りになる人が続出しているようだ。",
        "10月26日には女子高校生が病院送りになっているようだ。",
        "名前は氷堂儀子（ひょうどうのりこ）と言うらしい。",
        "また、蛇は本来この地域に生息していない種も目撃されているようだ。",
        "めぼしいものはこれくらいだろうか",
        "オカルト関連で蛇に関する知識があまりない。",
        "図書館のオカルトコーナーで情報を探る必要があるだろう。",
        "・本棚<break>オカルトコーナーで、気になる本を発見した。",
        "<fadeIn_item><item 2>タイトル：ぞわぞわする神様<break>蛇やトカゲなどの爬虫類、クモやハエなどの虫をモチーフとした神々、アメーバのように不定形の神々など、見ているだけでぞわぞわする挿絵付きの図鑑。",
        "<select1 2><select2 6><select3 none><text1 読む><text2 読まない><selectBox>読む？"
    ];
    text[2] = [
        "写真で見たようなシルエットの項目を見つけた。",
        "<skip 6><fadeIn_item><item 3>項目のタイトルは「蛇たちの父」と書かれており、ブードゥー教の神であることと、現れた場所には大量の蛇が出現することが記載されている。",
    ];
    ...
    text[4] = [
        "写真で見たようなシルエットの項目を見つけた。",
        "<skip 5><fadeIn_item><item 3>項目のタイトルは「蛇たちの父」と書かれており、ブードゥー教の神であることと、現れた場所には大量の蛇が出現することが記載されている。",
    ];
    text[5] = [
        "<fadeOut_item><fadeIn_chara 1 1>「この事件はつい先日起こった事件だったよな…」",
        "新聞コーナーに行くことにした。",
    ...
    text[6] = [
        "<fadeOut_item>調べ物をしていると誰かに見られている気がする。",
        "それが気になって、周囲を見回すと一人の男が立っていた。",
        "<fadeIn_chara 1 4>男は笑みを浮かべながら",
        "「君もあの事件を追っているのかい？」",
        "と、手に持つ資料を指さす。",
        ...
        "<fadeOut_chara 1 0>図書館で手に入る情報はこのくらいだろうか。",
        "図書館を後にした。",
    ...
    text[7] = [
        ...
        "<fadeIn_chara 1 4>「海斗、これは？」",
        "<fadeOut_chara 1 0><fadeIn_item><item 1>太郎が指さした先には、派手なピンク色のファーの装丁の手帳が落ちていた。",
        ...
        "<fadeOut_item>この周辺でそんな本、近所の古本屋にしか売ってないんじゃないかな？」",
        "<fadeOutIn_bg 4>",
        "・公園昼の公園は、家族連れが多く見られる。",
        "<fadeOut_chara 1 0>・古本屋図書館と違い、薄暗く札な整頓の店内。その店主はのんびりと茶を飲んで、おそらく売り物であろう本を読んでいる。",
        "どこから仕入れたのか想像できない本が多く、日本語ではないものも見える。",
        "<fadeIn_chara 1 16>「今日は若いのがよく来るなぁ」",
        "ふてぶてしい態度の店主がめんどくさそうにため息をついた。",
        "<fadeOut_chara 1 0><fadeIn_chara 4 16>「今日は何かお探しで？残念ながら前来た時と変わっちゃいないよ。」",
        "<fadeIn_chara 1 1>「いや、今日は人探しをしに来た。",
        ...
        "<fadeIn_chara 5 6>「氷堂とかいう女性を早急に止めないといけないみたいだね。」",
        "「あぁ。」",
        "太郎も同じ考えのようで、ため息をついた。",
        "<fadeOut_chara 5 0><fadeOut_chara 4 0><fadeOut_chara 1 0><fadeOutIn_bg 2>",
        "<fadeIn_chara 1 8>「今までのことを整理してみようか。」",
        ...
        "<fadeOut_chara 1 0><fadeOut_chara 4 0><fadeOut_chara 5 0><select1 9><select2 10><select3 9><text1 公園><text2 高台><text3 校庭><selectBox>どこだろうか？"
    ];

    text[8] = [
        "<fadeOutIn_bg 7>",
        "・病院清潔な印象を与える白い内装が海斗たちを出迎える。この地域の患者のほとんどはこの病院に来る総合病院だ。",
        "受付には看護師がいる",
        "<fadeIn_chara 1 4>「氷堂について看護師の人に聞いてみよっか。」",
        "太郎がためらうことなく一直線にカウンターへと向かう。太郎の後を追って行った。",
        "「すみません。」",
        "<fadeOut_chara 1 0><fadeIn_chara 2 14>「いかがなさいましたか？」",
        "<fadeIn_chara 3 4>「ここに氷堂儀子という女性が入院していたと思うのですが…」",
        "「ご親戚ですか？」",
        "「いえ、共通の趣味の友人です。」",
        ...
        "<fadeOut_chara 3 0><fadeOut_chara 2 0><fadeOutIn_bg 2>",
        "<fadeIn_chara 2 2>「おい、あんな嘘いいのかよ。」",
        "<fadeIn_chara 3 4>「情報を手に入れられたんだ、いいだろう？",
        ...
        "<fadeOut_chara 2 0><fadeOut_chara 3 0><fadeIn_item><item 4>手帳の最後にメモ用紙が挟まっていた。",
        "<fadeIn_chara 2 3><fadeOut_item>「…」",
        "<fadeIn_chara 3 6>「…",
        ...
        "太郎の言う通り、この近辺では開けた場所などそのくらいしかない。",
        "<fadeOut_chara 2 0><fadeOut_chara 3 0><select1 9><select2 10><select3 9><text1 公園><text2 高台><text3 校庭><selectBox>どこだろうか？"
    ];
    ...
    text[10] = [
        "<fadeOut_bg 0>氷堂がいると推理した場所へ向かう。",
        "<fadeIn_bg><bg 5>海の見える高台にやってくると、一人の女性がかがんで何かを描いていた。",
        "女性は金髪、褐色の肌で、近所の高校の制服を着ている。おそらく彼女が探していた氷堂儀子だろう。",
        "その手には、古くなりボロボロになった表紙の本を持っている。",
        "<fadeIn_chara 4 2>「あんたが氷堂儀子か。」",
        "ゆっくりと女性が立ち上がり振り返った。",
        "<fadeIn_chara 1 11>「そうだけど、なに？今忙しいんだけど。」",
        "<fadeIn_chara 5 5>「こんな儀式やめるんだ！」",
    ...
    text[12] = [
        ...
        "這い出るのが止まるとそれは人の形を成し、",
        "<fadeIn_chara 4 15>「かわいい女の子に呼ばれて飛び出てニャル様デス☆」",
        ...
        "<fadeOut_chara 1 0><fadeOut_chara 4 0><fadeOut_chara 5 0>ぐにゃりと目の前の男の形が崩れる。ぐちゃりと肉の濡れた音がしてバキリと骨の変形する音がする。",
